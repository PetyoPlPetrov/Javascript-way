...
In this context "lazy evaluation" represents the idea of not bothering to apply functions onto items when the goal is already achieved and those items dont actally need processing.
